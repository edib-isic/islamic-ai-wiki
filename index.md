# Sadaqah Jariyah Wiki — Islamic Foundations + AI Mastery for Halal Success
...
- **[Edib Isic](entities/edib-isic.md)** — Software Engineer, Germany, Steady Steward profile
- **[TMI — The Muslim Investor](entities/tmi-the-muslim-investor.md)** — Tools, curriculum, AAOIFI framework

### Concepts

- **[Sadaqah Jariyah](concepts/sadaqah-jariyah.md)** — Ongoing charity as primary wealth motivation
- **[Amanah](concepts/amanah.md)** — Wealth as sacred trust from Allah
- **[Riba](concepts/riba.md)** — Prohibition, current exposure, elimination strategy
- **[AAOIFI Screening](concepts/aaoifi-screening.md)** — Compliance framework for halal investing
